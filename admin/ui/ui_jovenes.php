                    ...
                    <div class="card-body table-responsive">
                        <table  id="zero_config" class="table table-light">
                            ...
                            <tbody>
                                ...
                                <td><a href="index.php?action=delete&id=<?=$lista['id_joven']?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                <td><a href="expedientes.php?action=exportar=<?=$lista['id_joven']?>" class="btn btn-dark"><i class="fas fa-file-pdf"></i></a></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
