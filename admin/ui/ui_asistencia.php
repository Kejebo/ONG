                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form_eventos" action="evento.php?action=update_voluntarios" method="post">
                                <table class="table table-light text-center" id="zero_config">
                                    ...
                                    <tbody>
                                        <?php foreach ($this->ln->db->get_asistencia_jovenes($_GET['id']) as $jovenes) { ?>
                                            <tr>
                                                ...
                                                <td><a href="inscripciones.php?action=update_voluntario_asistencia&id=<?= $_GET['id'] ?>&evento=<?= $_GET['id'] ?>&joven=<?= $jovenes['id_joven'] ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                            ...
                            <table class="table table-light zero_config">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($this->ln->db->get_asistentes_enlistado($_GET['id']) as $asistente) { ?>
                                        <tr>
                                            <td><input type="checkbox" name="asistente[]" value="<?= $jovenes['id_asistente'] ?>"></td>
